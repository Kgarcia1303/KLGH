...
@Given("the user is at the login page")
	...
	driver.findElement(By.id("proceed-link")).click();  //Aceptar la seguridad
	driver.findElement(By.xpath("//*[@id=\"myModal1\"]/div/div/button/span")).click(); //Cerrar la ventana modal
}
...
@And("the user clicks on Accept button")
	public void theUserClicks_on_accept_button () throws InterruptedException {
...
@Then("the BNC home page is displayed")
	public void theBNCHomeIsDisplayed () {
	String homeval = driver.findElement(By.xpath("//*[@id=\"kyop-breadcrumb-container\"]/div[1]/a")).getText();
